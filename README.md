# 🏗️ Assistente Virtual IoT com Redes Neurais para Automação Residencial
...
*   **Sistema de Temperatura:** Controlado por Perceptrom 
...
*   **Módulo de Segurança e Alarme:** Disparo autônomo de alertas sonoros de alta potência (sirenes e buzzers) acionados por comandos de voz de emergência, sensores de vazamento de gás ou gatilhos de sensores de presença.
